...
import {BrokerStructure, EmitterStructure, EventType, RouteStructure, ValidateStructure} from "../vendor";
...
export interface ISchemeLoader {
    ...
    readonly setValidator<
        H extends string = string
    >(domain: string, structure: ValidateStructure<H>): void
